...
Repositorio de apuntes, ejemplos y ejercicios basados en el curso de CSS de freeCodeCamp.
...
- [CSS Básico](./css-basico/)
  ...
  - [Diseño: Tarjeta de Publicación de Blog](./css-basico/tarjeta-publicacion-blog) &emsp;[![Práctica](./badges/badge-practica.svg)](#)
  - [Revisión de Fondos, Enlaces y Bordes](./css-basico/revision-fondos-enlaces-bordes.md) &emsp;[![Revisión](./badges/badge-revision.svg)](#)
- [Colores](./colores/)
...
- [Pseudo Clases y Elementos](./pseudo-clases-elementos/)
- [Tipografía](./tipografia/)
- [Estilizar Formularios](./estilizar-formularios/)
- [Variables (Custom Properties)](./variables/)

---

### 📱 Responsive y Accesibilidad
- [Diseño Responsivo](./diseño-responsive/)
...
### 🧪 Proyectos Prácticos
- [Página de Naipes](./proyecto-naipes/)
- [Aplicación de Inventario de Libros](./proyecto-inventario-libros/)
- [Página de Documentación Técnica](./proyecto-documentacion-tecnica/)
- [Página de Destino de Producto](./proyecto-destino-producto/)

---

### 🧠 Revisión
- [Revisión de CSS](./revision/)
...
Consolidar conocimientos de CSS mediante documentación estructurada, práctica constante y ejemplos reales.
